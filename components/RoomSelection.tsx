...
export const RoomSelection = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-stone-950 flex items-center justify-center p-4 font-serif relative overflow-hidden">
      {/* Background Ambience */}
      ...
      <div className="relative z-10 w-full max-w-4xl">
        ...
        <button 
          onClick={leaveGame}
          className="mt-12 mx-auto block text-stone-600 hover:text-stone-400 text-sm font-cinzel tracking-widest transition-colors"
        >
          ← 返回登录 (Back to Login)
        </button>
